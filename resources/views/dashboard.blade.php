    ...
    <div class="py-2">
      <div class="flex-col">
        <div class="max-w-7xl mx-auto sm:px-4 lg:px-8">
          ...
          <div class="flex items-center justify-center sm:px-6 sm:p-6 p-12">
            ...
            <div class="mx-auto w-full max-w-[550px]">
              <form action="" method="POST">
                ...
                <div class="pt-2">
                  <button
                    class="bg-[#2d9afa] hover:bg-blue-600  rounded-md sm:py-3 sm:px-8 px-6 py-2 text-base font-semibold text-black focus:outline-none"
                    >
                      Submit
                  </button>
                </div>
